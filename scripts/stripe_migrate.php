...
$queries = [
    'CREATE TABLE IF NOT EXISTS stripe_customers (
        ...
        CONSTRAINT fk_stripe_customers_account FOREIGN KEY (account_id) REFERENCES accounts(id) ON DELETE CASCADE
    ...
    'CREATE TABLE IF NOT EXISTS stripe_subscriptions (
        ...
        CONSTRAINT fk_stripe_subscriptions_account FOREIGN KEY (account_id) REFERENCES accounts(id) ON DELETE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
...
foreach ($queries as $query) {
    if (!$db->query($query)) {
        fwrite(STDERR, 'Migration failed: ' . $db->error . PHP_EOL);
        exit(1);
    }
}

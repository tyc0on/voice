...
<head>
    <base href="" />
    <title>
        Recover Password - <?php echo $sitename; ?>
    </title>
    <meta charset="utf-8" />
    ...
    <meta property="og:title" content="EasyAi Studio - Unlock 10x Productivity with Easy AI solutions" />
    <meta property="og:url" content="https://easyai.studio" />
    <meta property="og:site_name" content="EasyAi Studio" />
...
<body data-kt-name="EasyAi Studio" id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-column">
                    ...
                    <h2 class="text-white fw-normal m-0">
                        Unlock 10x Productivity with Easy AI solutions
                    </h2>
                    <!--end::Title-->
                </div>
                <!--begin::Aside-->
            ...
            <div class="d-flex flex-center w-lg-50 p-10">
                ...
                <div class="card rounded-3 w-md-550px">
                    ...
                    <div class="card-body p-10 p-lg-20">
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="new-password.html" action="#">
                            <!--begin::Heading-->
                            ...
                            <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                                ...
                                <a href="sign-in.php" class="btn btn-light">Cancel</a>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->

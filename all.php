								...
								<div class="table-responsive">
									...
									<table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
										...
										<tbody class="fs-6">
											...
											$sql = "SELECT * FROM jobs LEFT JOIN audio_files ON audio_files.id = jobs.audio_id LEFT JOIN paudio_files ON paudio_files.job_id = jobs.id WHERE jobs.user_id = ? ORDER BY jobs.id DESC";
											$stmt = $con->prepare($sql);
